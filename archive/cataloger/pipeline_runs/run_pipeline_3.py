#!/usr/bin/env python3
"""Runner for pipeline 3."""

import json
import time
import sys
import archive.cataloger.pipeline_runs.pipeline_3 as pipeline_3
...
def main():
    ...
    print(f"Starting pipeline 3...")

    start_time = time.time()

    try:
        result = pipeline_3.classify_catalog(catalog)
        ...
        runtime = time.time() - start_time
        print(f"\nPipeline 3 FAILED after {runtime:.2f}s")
        print(f"Error: {e}")
        import traceback
        traceback.print_exc()
