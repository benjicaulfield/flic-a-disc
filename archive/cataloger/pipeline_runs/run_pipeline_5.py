#!/usr/bin/env python3
"""Runner for pipeline 5."""

import json
import time
import sys
import archive.cataloger.pipeline_runs.pipeline_5 as pipeline_5
...
def main():
    ...
    print(f"Starting pipeline 5...")

    start_time = time.time()

    try:
        result = pipeline_5.classify_catalog(catalog)
        ...
        runtime = time.time() - start_time
        print(f"\nPipeline 5 FAILED after {runtime:.2f}s")
        print(f"Error: {e}")
        import traceback
        traceback.print_exc()
