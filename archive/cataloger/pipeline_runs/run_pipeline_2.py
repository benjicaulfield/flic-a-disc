#!/usr/bin/env python3
"""Runner for pipeline 2."""

import json
import time
import sys
import archive.cataloger.pipeline_runs.pipeline_2 as pipeline_2
...
def main():
    ...
    print(f"Starting pipeline 2...")

    start_time = time.time()

    try:
        result = pipeline_2.classify_catalog(catalog)
        ...
        runtime = time.time() - start_time
        print(f"\nPipeline 2 FAILED after {runtime:.2f}s")
        print(f"Error: {e}")
        import traceback
        traceback.print_exc()
