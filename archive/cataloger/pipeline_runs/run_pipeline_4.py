#!/usr/bin/env python3
"""Runner for pipeline 4."""

import json
import time
import sys
import archive.cataloger.pipeline_runs.pipeline_4 as pipeline_4
...
def main():
    ...
    print(f"Starting pipeline 4...")

    start_time = time.time()

    try:
        result = pipeline_4.classify_catalog(catalog)
        ...
        runtime = time.time() - start_time
        print(f"\nPipeline 4 FAILED after {runtime:.2f}s")
        print(f"Error: {e}")
        import traceback
        traceback.print_exc()
