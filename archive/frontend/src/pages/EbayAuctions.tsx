...
import type { BasicEbayListing } from "../../types";
...
const EbayAuctions = () => {
  const {
    ...
    toggleLabel,
    submitAnnotations
  } = useEbayListings<BasicEbayListing>('/api/ebay/auctions', '/api/ebay/refresh_auctions');
  ...
  const {
      ...
      hasNextPage,
      hasPreviousPage
    } = Paginate<BasicEbayListing>(listings, 40);
